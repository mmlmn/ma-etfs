...
etfw20l_quima_tc_type_tab <- etfw20l_quima_tc_type_dat %>%
...
```{r, etfw20l-quima-score, message=FALSE, warning=FALSE, fig.align = "center", out.width = "50%", fig.cap = "[QUIMA] ETFW20L -- IR score by value of the long-term lag.", fig.ncol = 2, fig.nrow = 2, fig.subcap = c("For effective strategies (IR > 0)", "For effective strategies (IR > 0), with band $\\geq$ 0.04", "For the whole sample", "For the whole sample, with band $\\geq$ 0.04")}


etfw20l_quima_tc_analysis$plot_lag_IR
etfw20l_quima_tc_analysis$plot_lag_IRb
etfw20l_quima_tc_analysis$plot_lag_IRws
etfw20l_quima_tc_analysis$plot_lag_IRwsb
...
# 
etfw20l_quima_tc_analysis$plot_heat_wma
etfw20l_quima_tc_analysis$plot_heat_wmas
...
etfw20l_quima_tc_drawdowns_tab <- etfw20l_quima_tc_results$drawdowns_data %>% 
  mutate(across(everything(),
                ~ case_when(is.na(.) ~ cell_spec(., "latex", color = "lightgray"),
...
etfw20l_quima_tc_drawdowns_tab
...
```{r, etfw20l-quima-drawdowns-fig, out.width = "100%", fig.cap = "[QUIMA] Drawdowns for two top (blue and orange), two bottom (gray) and the middle (green) strategy, vs drawdowns for the BH benchmark (red).", fig.align = "center"}


knitr::include_graphics("data/results/static/ETFW20L_quima_tc_drawdowns.png")
